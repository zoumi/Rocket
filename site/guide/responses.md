...
[JSON example on GitHub]: https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/json
...
GitHub](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/handlebars_templates)
