...
example](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/todo/static/index.html.tera#L47)
...
[cookies example]: https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/cookies
...
The [forms validation](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/form_validation)
and [forms kitchen sink](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/form_kitchen_sink)
...
[JSON example]: https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/json
...
[GitHub example
code](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/raw_upload)
for the full crate.
...
`query_params`
example](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/query_params).
...
example](https://github.com/SergioBenitez/Rocket/tree/v0.3.5/examples/errors) on
