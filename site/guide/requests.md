...
example](https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/todo/static/index.html.tera#L47)
...
[cookies example]: https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/cookies
...
The [forms](https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/forms)
and [forms kitchen
sink](https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/form_kitchen_sink)
...
[JSON example]: https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/json
...
[GitHub example
code](https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/raw_upload)
for the full crate.
...
`query_params`
example](https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/query_params).
...
example](https://github.com/SergioBenitez/Rocket/tree/v0.3.1/examples/errors) on
